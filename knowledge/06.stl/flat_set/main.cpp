...
void algorithm_process(void)
{
    ...
    std::flat_set<int> vcon_0{2, 3, 3, 5, 7, 7, 1};
    std::flat_set<int> vcon_1{4, 6};
    ...
    auto search_seq = std::flat_set<int>{3, 5};
    ...
    std::flat_set<int> vcon_4 = {1, 3, 5};
    std::flat_set<int> vcon_5 = {2, 3, 4, 6, 8};
    std::flat_set<int> vcon_6;
...
int main(int argc, char* argv[])
{
    ...
    std::flat_set<int> arr_set(array, array+5);
    std::flat_set<int> usr_set(arr_set);
    std::flat_set<std::string> str_set;
    
    //operator=
    str_set = std::flat_set<std::string>({"0x00", "0x01", "0x02"});
    ...
    std::flat_set<int>::iterator iterbegin = usr_set.begin();
    std::flat_set<int>::iterator iterend = usr_set.end();
    std::flat_set<int>::const_iterator iterconstbegin = usr_set.cbegin();
    std::flat_set<int>::const_iterator iterconstend = usr_set.cend();
    std::flat_set<int>::reverse_iterator iterrbegin = usr_set.rbegin();
    std::flat_set<int>::reverse_iterator iterrend = usr_set.rend();
    std::flat_set<int>::const_reverse_iterator iterconstrbegin = usr_set.crbegin();
    std::flat_set<int>::const_reverse_iterator iterconstrend = usr_set.crend();
    ...
    std::pair<std::flat_set<int>::const_iterator, std::flat_set<int>::const_iterator> ret;
    ...
    std::flat_set<int>::const_iterator iterlower = usr_set.lower_bound(5);
    std::flat_set<int>::const_iterator iterupper = usr_set.upper_bound(5);
