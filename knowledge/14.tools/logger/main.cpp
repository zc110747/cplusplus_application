...
int main(void)
{
    LOG_MESSAGE(logger_manage::LOGGER_LEVEL::DEBUG, 10, "Hello, {}!", "World");
    LOG_MESSAGE(logger_manage::LOGGER_LEVEL::INFO, 20, "The answer is {}", 42);
    LOG_MESSAGE(logger_manage::LOGGER_LEVEL::FATAL, 30, "Multiple arguments: {}, {}, {}", 1, "B", "C");
    
    LOG_DEBUG(60, "This is a debug message");
    LOG_INFO(120, "This is an info message");
    LOG_WARN(150, "This is a warning message");
    LOG_ERROR(210, "This is an error message");
    LOG_FATAL(540, "This is a fatal message");

    logger_manage::get_instance()->set_log_level(logger_manage::LOGGER_LEVEL::INFO);
    LOG_DEBUG(1200, "This is a debug message");       // not logger_manage
    LOG_INFO(3600, "This is an info message");

    logger_manage::get_instance()->set_log_level(logger_manage::LOGGER_LEVEL::FATAL);
    LOG_WARN(5400, "This is a warning message");     // not logger_manage
    LOG_FATAL(1200000, "This is a fatal message")
    return 0;
}
