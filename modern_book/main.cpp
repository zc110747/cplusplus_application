...
pfunc function_list[] = {
    BASE_TYPE::test_run,          NAMESPACE::test_run,        AUTO::test_run,             DECLTYPE::test_run,
    POSTF_RETURN::test_run,       REFERENCE::test_run,        LAMBDA::test_run,           INITIALIZATION::test_run,
    INITIALIZE_LIST::test_run,    CONSTRUCT::test_run,        UNION::test_run,            DELEGATION::test_run,
    INHERIT::test_run,            STRONG_ENUM::test_run,      AGGREGATE::test_run,        OVERRIDE::test_run,
    FOR_LOOP::test_run,           CHOOSE_INIT::test_run,      STATIC_ASSERT::test_run,    STRUCT_BIND::test_run,
    NOEXCEPT::test_run,           TEMPLATE_ALIAS::test_run,   NULLPTR::test_run,          SPACESHIP::test_run,
    THREAD_LOCAL::test_run,       INLINE::test_run,           CONSTEXPR::test_run,        EVAL_ORDER::test_run,
    LITERAL::test_run,            ALIGN::test_run,            ATTRIBUTE::test_run,        PREPROCESS::test_run,
    COROUTINES::test_run,         OTHER_OPTIMIZE::test_run,   TEMPLATE_VAR::test_run,     TYPENAME::test_run,
    TEMPLATE_IMPROVE::test_run,   TEMPLATE_DERIVE::test_run,  DERIVATION::test_run,       SFINAE::test_run,
    CONCEPT::test_run,            TEMPLATE_OPTIMIZE::test_run
};
